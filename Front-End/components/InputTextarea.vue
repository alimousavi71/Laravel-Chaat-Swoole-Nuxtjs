<template>
  <div>
    <div class="relative">
      <textarea
        class="w-full px-4 py-3 resize-none text-sm transition-all duration-500 rounded-md bg-dark-themeColor1 focus:outline-none text-dark-text1 focus:border-dark-themeColor2"
        type="text"
        :value="value"
        :class="{
          'pl-12': icon,
          'border border-dark-red1  border-opacity-100 text-dark-red1':
            errors.length,
          'border border-green-500 border-opacity-100 text-green-500':
